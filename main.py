...
tokens = css_parser.tokenize("p")
conditions, relations, target = css_parser.parse_selector(tokens)
print(selector.filter_by_targeted_selector(root, conditions, relations, target))
